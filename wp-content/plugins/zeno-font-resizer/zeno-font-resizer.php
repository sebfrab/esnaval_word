...
function zeno_font_resizer_place( $echo = true ) {
	...
	<div class="zeno_font_resizer_container">
		<p class="zeno_font_resizer">
			<span>
				<a href="#" class="zeno_font_resizer_minus" title="' . esc_attr__( 'reducir', 'zeno-font-resizer' ) . '" >' . get_option('zeno_font_resizer_letter') . '-</a>
				<a href="#" class="zeno_font_resizer_reset" title="' . esc_attr__( 'restablecer', 'zeno-font-resizer' ) . '">' . get_option('zeno_font_resizer_letter') . '</a>
				<a href="#" class="zeno_font_resizer_add" title="' . esc_attr__( 'aumentar', 'zeno-font-resizer' ) . '" >' . get_option('zeno_font_resizer_letter') . '+</a>
			</span>
